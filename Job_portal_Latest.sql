...
CREATE TABLE user_skills (
 ...
 CREATE TABLE job_skills (
	...
	SELECT * FROM users WHERE username = 'Laura';
    SELECT * FROM users WHERE username = 'Joshua'; 
	SELECT * FROM users WHERE username = 'Carol';
	SELECT * FROM users WHERE username = 'Emma';
    SELECT * FROM users WHERE username = 'Donna';
	SELECT * FROM users WHERE username = 'Amanda';
	SELECT * FROM users WHERE username = 'Amy';
	SELECT * FROM users WHERE username = 'Sharon';
	SELECT * FROM users WHERE username = 'Brenda';
	SELECT * FROM users WHERE username = 'Kimberley';
    SELECT * FROM users WHERE username = 'Donald';
    SELECT * FROM users WHERE username = 'Emily';
    SELECT * FROM users WHERE username = 'Zion';
    SELECT * FROM users WHERE username = 'Gracy';
    SELECT * FROM users WHERE username = 'Gary';
    SELECT * FROM users WHERE username = 'Jason';
    SELECT * FROM users WHERE username = 'Kenneth';
    SELECT * FROM users WHERE username = 'Katty';
    SELECT * FROM users WHERE username = 'Helen';
	SELECT * FROM users WHERE username = 'Rebecca';

SELECT * FROM users WHERE user_type_id = 3;

	INSERT INTO company (companyname) VALUES ('Amazon');
    INSERT INTO company (companyname) VALUES ('Capgemini');
    INSERT INTO company (companyname) VALUES ('Uber');
    INSERT INTO company (companyname) VALUES ('Apple');
    INSERT INTO company (companyname) VALUES ('Target');
    INSERT INTO company (companyname) VALUES ('Walmart');
    INSERT INTO company (companyname) VALUES ('Infosys');
    INSERT INTO company (companyname) VALUES ('Deloitte');
    INSERT INTO company (companyname) VALUES ('Nike');
    INSERT INTO company (companyname) VALUES ('Adidas');
    INSERT INTO company (companyname) VALUES ('Fossil');
    INSERT INTO company (companyname) VALUES ('Oats');
    INSERT INTO company (companyname) VALUES ('Meta');
    INSERT INTO company (companyname) VALUES ('Tesla');
    INSERT INTO company (companyname) VALUES ('Homedepot');
    INSERT INTO company (companyname) VALUES ('Wayfair');
    INSERT INTO company (companyname) VALUES ('Mailchimp');
    INSERT INTO company (companyname) VALUES ('Twitter');
    INSERT INTO company (companyname) VALUES ('CNBC');
    INSERT INTO company (companyname) VALUES ('Orkut');
    INSERT INTO company (companyname) VALUES ('Yahoo');
